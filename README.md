...
- [OmniMac](https://bysergimm.github.io/OmniMac/en/) - Dynamic Island for any Mac (notch or not) plus ten more utilities in one lightweight menu-bar app: keep-awake, ⌘Tab by windows, window shortcuts and layouts, clipboard history, per-app volume and equaliser, performance monitor, OCR and app cleaner. [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
